...
<script>
    ...
    {
        $("#regcoDiv").empty();
        let imageInput = "<h2>点击图片区域上传文件</h2><input style='display: none' type='file' name='file1' id='file1' multiple='multiple' /><br><img src='images/background.png' onclick='chooseFile()' id='img0' style='width: 30rem;height: 25rem;'>";
